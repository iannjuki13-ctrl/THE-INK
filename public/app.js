...
async function loadFeeds(){
  clearUI();
  postList.innerHTML = '<p style="text-align:center;color:#ccc;padding:2rem">Fetching latest news...</p>';
  try {
    ...
    console.error(err);
    postList.innerHTML = '<p style="text-align:center;color:red;padding:2rem">Failed to load news.</p>';
  }
}

// Auto-refresh every 5 seconds
loadFeeds();
refreshTimer = setInterval(loadFeeds, 5000);
